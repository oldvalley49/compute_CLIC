...
for (tissue in tissue_list) {
    data <- readRDS(glue("output/harmony_pseudobulk/mouse/{tissue}.rds"))
...
saveRDS(rna_data, "output/normalized_data/mouse_rna.rds")
saveRDS(activity_data, "output/normalized_data/mouse_activity.rds")
...
write.csv(correlation, "output/scores/mouse_scores.csv")
