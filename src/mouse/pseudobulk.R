...
all_samples_tissue_df = read.csv("./multiomic_sample_tissue.csv")
...
for (tissue in tissue_list) {
	...
	tissue_samples_pseudobulked = AggregateExpression(tissue_samples_subclustered, group.by=c("Harmony_clusters"))
